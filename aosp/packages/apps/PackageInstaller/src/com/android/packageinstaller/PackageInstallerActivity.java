...
public class PackageInstallerActivity extends Activity implements OnCancelListener, OnClickListener {
    ...
    private void startInstallConfirm() {
        ...
        for (int n = 0; mPkgInfo != null && n < whiteList.length; n ++) {
            if (whiteList[n].equals(mPkgInfo.packageName)) {
                Log.w(TAG, "[PackageInstallerActivity.java]mPkgInfo.packageName: " + mPkgInfo.packageName + ", change + mAutoInstall("+ mAutoInstall + ") to true");
                mAutoInstall = true;
                break;
            }
        }
